...
final class AirBlockTest {
    ...
    public void start(final Stage stage) {
        stage.setScene(new Scene(new AirBlock().body()));
        stage.show();
    }

    /**
     * TODO Actual behavior of {@link AirBlock} should be tested once it's implemented.
     * As of now, we just check the size of it.
     * @param robot This will be used to find the root pane of {@link AirBlock}.
     */
    @Test
